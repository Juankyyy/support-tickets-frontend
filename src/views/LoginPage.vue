<template>
    <div class="content">
        <form >
            ...
            <label class="input sm:w-96 input-bordered flex items-center gap-2">
            ...
            <label class="input sm:w-96 input-bordered flex items-center gap-2">
                ...
                <input type="password" class="grow" placeholder="123456"/>
            </label>

            <button class="btn btn-success w-full font-bold">Iniciar Sesión</button>
        </form>
    </div>
</template>
